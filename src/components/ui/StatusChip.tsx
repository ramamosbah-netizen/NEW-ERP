...
export const StatusChip: React.FC<StatusChipProps> = ({ status, className = '' }) => {
  ...
  const chipConfig: Record<StatusType | string, { label: string; bg: string; text: string; border: string }> = {
    ...
    SENT: { label: 'Sent', bg: 'rgba(0, 229, 160, 0.12)', text: '#00E5A0', border: 'rgba(0, 229, 160, 0.25)' },
    SENT_TO_CLIENT: { label: 'Sent to Client', bg: 'rgba(0, 229, 160, 0.12)', text: '#00E5A0', border: 'rgba(0, 229, 160, 0.25)' },
    SUBMITTED: { label: 'Submitted (Pre-Award)', bg: 'rgba(192, 132, 252, 0.12)', text: '#c084fc', border: 'rgba(192, 132, 252, 0.25)' },
    ACCEPTED: { label: 'Accepted', bg: 'rgba(34, 211, 238, 0.12)', text: '#22d3ee', border: 'rgba(34, 211, 238, 0.25)' },
    REJECTED: { label: 'Rejected', bg: 'rgba(239, 68, 68, 0.12)', text: '#fca5a5', border: 'rgba(239, 68, 68, 0.25)' },
    REVISED: { label: 'Revised', bg: 'rgba(168, 85, 247, 0.12)', text: '#d8b4fe', border: 'rgba(168, 85, 247, 0.25)' },
    SUPERSEDED: { label: 'Superseded', bg: 'rgba(100, 116, 139, 0.1)', text: '#64748b', border: 'rgba(100, 116, 139, 0.18)' },
    MOBILIZATION: { label: 'Mobilization', bg: 'rgba(168, 85, 247, 0.12)', text: '#d8b4fe', border: 'rgba(168, 85, 247, 0.25)' },
    ...
    DLP: { label: 'DLP (Warranty)', bg: 'rgba(34, 211, 238, 0.12)', text: '#22d3ee', border: 'rgba(34, 211, 238, 0.25)' },
    ...
    PARTIALLY_PAID: { label: 'Partially Paid', bg: 'rgba(34, 211, 238, 0.12)', text: '#22d3ee', border: 'rgba(34, 211, 238, 0.25)' },
