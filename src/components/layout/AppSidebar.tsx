...
const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { href: '/workspace/approvals', label: 'Approvals', icon: CheckSquare },
      ...
      { href: '/workspace/activity', label: 'Activity Timeline', icon: Activity },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/hr/certifications', label: 'Certifications', icon: Award },
      { href: '/hr/competency', label: 'Training & Competency', icon: GraduationCap },
      { href: '/hr/attendance', label: 'Attendance & GPS', icon: MapPin },
      { href: '/hr/documents', label: 'Documents Center', icon: FolderArchive },
