...
<main className="flex-1 max-w-7xl w-full mx-auto px-6 py-8 flex flex-col gap-6">
        ...
        <div>
          <div className="text-[10px] text-slate-500 font-mono uppercase tracking-widest flex items-center gap-1">
            <Link href="/finance/ar" className="hover:text-emerald-400 flex items-center gap-0.5"><ArrowLeft size={10} /> Registry</Link> &gt; <span className="text-slate-300">Aging Analysis</span>
          </div>
              ...
              <tbody>
                {loading ? (
                  ...
                  clientAging.map(client => (
                    <tr 
                      key={client.clientId} 
                      className="border-b border-slate-900/50 hover:bg-emerald-500/5 transition-all cursor-pointer"
