        ...
        <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded p-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 text-xs">
            <div className="bg-[var(--bg-card)]/40 p-4 rounded border border-[var(--border)]">
              <span className="text-[var(--text-primary)]0 block uppercase font-mono text-[9px]">Total Outstanding</span>
            ...
            <div className="bg-[var(--bg-card)]/40 p-4 rounded border border-[var(--border)]">
              ...
              <span className="text-[10px] text-[var(--text-primary)]0 font-mono mt-0.5 block">{getPct(agingSummary.current)}</span>
            </div>
            ...
            <div className="bg-[var(--bg-card)]/40 p-4 rounded border border-[var(--border)]">
              ...
              <span className="text-[10px] text-[var(--text-primary)]0 font-mono mt-0.5 block">{getPct(agingSummary.bucket1_30)}</span>
            </div>
            ...
            <div className="bg-[var(--bg-card)]/40 p-4 rounded border border-[var(--border)]">
              ...
              <span className="text-[10px] text-[var(--text-primary)]0 font-mono mt-0.5 block">{getPct(agingSummary.bucket31_60)}</span>
            </div>
            ...
            <div className="bg-[var(--bg-card)]/40 p-4 rounded border border-[var(--border)]">
              ...
              <span className="text-[10px] text-[var(--text-primary)]0 font-mono mt-0.5 block">{getPct(agingSummary.bucket61_90)}</span>
            </div>
            ...
            <div className="bg-[var(--bg-card)]/40 p-4 rounded border border-[var(--border)]">
              ...
              <span className="text-[10px] text-[var(--text-primary)]0 font-mono mt-0.5 block">{getPct(agingSummary.bucket90_plus)}</span>
            </div>
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-left text-xs">
              ...
              <tbody>
                {loading ? (
                  <tr>
                    <td colSpan={7} className="py-8 text-center text-[var(--text-primary)]0 font-mono">
